...
| `fix/p2-test-suite-reliability` | 🟡 in progress | Duplicate mock-db helper removed; component tests import real UI + RTL; throttle uses fake timers. E2E rebuild-skip / retries and Artist/Playlist GridContainer copies — recorded in [Backlog](#backlog-not-implemented-yet), not in this branch. |
